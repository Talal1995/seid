...
const SurveyPage = () => {
  ...
  const countryCodes = [
    ...
    { value: "+966", label: isRTL ? "السعودية (+966)" : "Saudi Arabia (+966)" },
    { value: "+968", label: isRTL ? "عمان (+968)" : "Oman (+968)" },
    { value: "+965", label: isRTL ? "الكويت (+965)" : "Kuwait (+965)" },
    { value: "+974", label: isRTL ? "قطر (+974)" : "Qatar (+974)" },
    { value: "+962", label: isRTL ? "الأردن (+962)" : "Jordan (+962)" },
